...
def start():
  ...
  while True:
    time.sleep(SLEEP_BETWEEN_ACTIONS)
    input_1 = input("\n" + player1_name + ": " + random.choice(player_turn_text) + " Click any key to roll the dice: ")
    print("\nRolling dice...")
    ...
    input_2 = input("\n" + player2_name + ": " + random.choice(player_turn_text) + " Click any key to roll the dice: ")
    print("\nRolling dice...")
    dice_value = get_dice_value()
    time.sleep(SLEEP_BETWEEN_ACTIONS)
    ...
    input_3 = input("\n" + player3_name + ": " + random.choice(player_turn_text) + " Click any key to roll the dice: ")
    print("\nRolling dice...")
    dice_value = get_dice_value()
    time.sleep(SLEEP_BETWEEN_ACTIONS)
    ...
    input_4 = input("\n" + player4_name + ": " + random.choice(player_turn_text) + " Click any key to roll the dice: ")
    print("\nRolling dice...")
    dice_value = get_dice_value()
    time.sleep(SLEEP_BETWEEN_ACTIONS)
